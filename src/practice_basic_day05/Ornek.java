...
public class Ornek {
    ...
    private static String soyIsimDegistir(String ogrenciSoyIsim) {
        ...
        System.out.println("yeni soy isim girin");
        ogrenciSoyIsim=scan.nextLine();
        return ogrenciSoyIsim;
    }

    private static void isimDegistir(String ogrenciIsim, String ogrenciSoyIsim, String ogrenciTel) {
        ogrenciIsim ="Mehmet";
